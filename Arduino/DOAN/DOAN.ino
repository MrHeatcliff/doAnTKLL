...
#define BEAT_PATH "/data/HCMUT1/beat";
#define SPO2_PATH "/data/HCMUT1/SpO2";
...
// String beat_path = "/data/" + device_id + "/beat";
// String spo2_path = "/data/" + device_id.c_str() + "/SpO2";
...
void loop()
{
    ...
    count%=NUMBER_SAMPLE;
      ...
      Serial.println("%");
      if(count == NUMBER_SAMPLE-1){
        pox.shutdown();
        databasePath = BEAT_PATH;
        Firebase.setFloat(fbdo, databasePath, beat_send);
        databasePath = SPO2_PATH;
